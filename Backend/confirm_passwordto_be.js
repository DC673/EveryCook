...
async function startConsumer() {
  try {
    ...
    const receiveQueue = 'confirmed_password';
...
async function sendToDatabaseConsumer(userData) {
  try {
    ...
    const sendQueue = 'backend_confirmed_password';
    ...
    console.log(" [x] Sent confirmed passwrd to backend consumer:", modifiedUserData);
